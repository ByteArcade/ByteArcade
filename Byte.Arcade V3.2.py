...
while True:
    ...
    if game == 0:
        ...
        print("Toute reproduction, distribution ou modification")
        print("sans autorisation expresse est strictement interdite.\n")
        print("Contact : [lou@tingvall.se]\n")                                                                                       ##################################mail
        print("===================================================\n\n")
        ...
        for i in range(rrnbr):
            ...
            print("Attention ! l'ordre de passage peut paraître incohérent, mais nous vous assurons qu'il l'est.")
