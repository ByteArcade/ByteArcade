...
# le fichier, et de profiter de l'experience !

# ATTENTION : il est possible que la console
...
# pas la meuilleure expérience de jeu que nous vous
# avons imaginé.
...
os_test = False
time_choice = True
cl_input_choice = True

def pause(temps):
    if time_choice == True:
        time.sleep(temps)
    elif time_choice == False:
        pass
    else:
        cl()
        print("\033[41m=== ATTENTION ===")
        print("\n\033[91mUne erreur est survenue, veuillez relancer le jeu.\033[0m")

def os_error():
    global os_test
    while True:
        print("\t\t\033[41m=== ATTENTION ===\033[0m")
        print("\n\033[35mPour information, la commande 'cl()' est indisponible.")
        print("\n\033[33mPour continuer sans, tapez \033[32m-1-\033[33m ou pour quitter, tapez \033[32m-0-\033[33m.")
        choix = input("\n->\033[0m")
        if choix == "1":
            os_test = "NA"
            break
            ...
            print("\033[41mSaisi ivalide, veuillez saisir un nombre entre 1 et 2.\033[0m")
...
def turn_off_on_os():
    ...
    while True:
        cl()
        print("\t\t\033[41m=== ATTENTION ===\033[0m")
        print("\n\033[95mÊtes vous sur de vouloir désactiver la commande 'cl()' ?")
        print("\n\t\033[91mRemarque : la désactivation de l'option entraînera l'abaissement de l'affichage.")
        print("\n\033[93mDÉSACTIVER : \033[92m-1-\033[93m\t\tACTIVER : \033[92m-2-\033[93m\t--\tREVENIR : \033[92m-0-\033[93m.")
        choix = input("\n->\033[0m")
        if choix == "1":
            os_test = "NA"
            print("\n\033[91mLa commande 'cl()' a été désactivée.\033[0m")
            pause(1.2)
            return
        elif choix == "2":
            os_test = False
            print("\n\033[91mLa commande 'cl()' a été activée.\033[0m")
            pause(1.2)
            return
        elif choix == "0":
            return
        else:
            print("\033[41mSaisi invalide, veuillez saisir un nombre entre 1, 2 et 0.\033[0m")
            pause(1.2)

def turn_off_on_time():
    global time_choice
    while True:
        cl()
        print("\t\t\033[41m=== ATTENTION ===\033[0m")
        print("\n\033[95mÊtes vous sur de vouloir désactiver la commande 'time.sleep()' ?")
        print("\n\033[93mDÉSACTIVER : \033[92m-1-\033[93m\t\tACTIVER : \033[92m-2-\033[93m\t--\tREVENIR : \033[92m-0-\033[93m.")
        choix = input("\n->\033[0m")
        if choix == "1":
            time_choice = False
            print("\n\033[91mLa commande 'time.sleep()' a été désactivée.\033[0m")
            pause(1.2)
            return
        elif choix == "2":
            time_choice = True
            print("\n\033[91mLa commande 'time.sleep()' a été activée.\033[0m")
            pause(1.2)
            return
        elif choix == "0":
            return
...
def turn_off_on_cl_input():
    global cl_input_choice
    while True:
        cl()
        print("\t\t\033[41m=== ATTENTION ===\033[0m")
        print("\n\033[95mÊtes vous sur de vouloir désactiver la commande 'cl_input()' ?")
        print("\n\033[93mDÉSACTIVER : \033[92m-1-\033[93m\t\tACTIVER : \033[92m-2-\033[93m\t--\tREVENIR : \033[92m-0-\033[93m.")
        choix = input("\n->\033[0m")
        if choix == "1":
            cl_input_choice = False
            print("\n\033[91mLa commande 'cl_input()' a été désactivée.\033[0m")
            pause(1.2)
            return
        elif choix == "2":
            cl_input_choice = True
            print("\n\033[91mLa commande 'cl_input()' a été activée.\033[0m")
            pause(1.2)
            return
        elif choix == "0":
            return
...
def affichage_menu_parametres():
    ...
    print("\n\033[95mActiver / Désactiver la fonction 'cl()' : \033[92m-1-")
    print("\n\033[95mActiver / Désactiver la fonction 'pause()' : \033[92m-2-")
    print("\n\033[95mActiver / Désactiver la fonction 'cl_input' : \033[92m-3-")
    print("\n\033[91mRetour : -0-\033[0m")
    print("\t\t\t\t\t\t\033[93mby Byte.Games Studios © 2025\033[0m")
