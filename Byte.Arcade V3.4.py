...
while True:
    ...
    if game == 0:
        ...
        print("Ce jeu, ainsi que son code source, ses ressources et son identité visuelle, sont protégés par le droit d’auteur selon les dispositions du Code de la propriété intellectuelle (France, Union européenne).")
        ...
        print("Q : Comment lancer un jeu dans Py_Terminal ?")
        ...
        print("R : Envoyez un mail à // lou@tingvall.se // avec une description claire du problème ou de votre idée.\n")
        print("Q : Ce jeu est-il gratuit ?")
        print("R : Oui, Code’n’Play est un projet personnel gratuit, à but éducatif et ludique.\n")
